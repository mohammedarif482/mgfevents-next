          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-3">
              {[
                ...
                { 
                  name: 'Facebook', 
                  href: 'https://www.facebook.com/mgfeventz/', 
                  icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                { 
                  name: 'Instagram', 
                  href: 'https://www.instagram.com/mgfevent?utm_source=ig_web_button_share_sheet&igsh=MXF5OXFoaGt2a3FlZQ==', 
                  icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                { 
                  name: 'YouTube', 
                  href: 'https://www.youtube.com/@mgfevents5831', 
                  icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                { 
                  name: 'Pinterest', 
                  href: 'https://uk.pinterest.com/mgfevent01/', 
                  icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  key={social.name}
                  href={social.href}
className="w-12 h-12 bg-gray-800 hover:bg-[#E55E27] rounded-2xl flex items-center justify-center transition-colors group"                  aria-label={social.name}
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    href={link.href}
className="text-gray-300 hover:text-[#E55E27] transition-colors inline-flex items-center group"                  >
                    {link.name}
                    <svg 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: 'Catering Services', href:  '/services'},
                { name: 'Photography', href:  '/services' },
                { name: 'Venue Consultation', href:  '/services'},
              ].map((service) => (
                <li key={service.name}>
                  <Link
                    href={service.href}
className="text-gray-300 hover:text-[#E55E27] transition-colors inline-flex items-center group"                  >
  ...
  <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
    ...
    <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-sm">
      <Link 
        href="/" 
      className="text-gray-400 hover:text-[#E55E27] transition-colors"
      >
       © 2025 MGF Events | All Rights Reserved
      </Link>
      {/* <Link 
