          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <div key={index} className="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-2">
                <div className={`h-24 bg-gradient-to-br ${info.color} flex items-center justify-center`}>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2">
                    {info.details.map((detail, idx) => (
                      <p key={idx} className={`text-gray-600 ${idx === info.details.length - 1 ? 'text-sm font-medium text-primary-600' : ''}`}>
                        {detail}
                      </p>
                    ))}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Quick Services */}
              <div className="bg-white rounded-3xl shadow-lg p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 font-serif">Our Services</h3>
              ...
              <div className="bg-primary-50 rounded-3xl p-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-6 font-serif">Why Choose MGF Events?</h3>
              ...
              <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-3xl p-8 text-white">
                ...
                <div className="space-y-3">
                  <a href="tel:+919876543210" className="flex items-center space-x-3 hover:text-primary-200 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                    <span>+91 98765 43210</span>
                  </a>
                  <a href="https://wa.me/919876543210" className="flex items-center space-x-3 hover:text-primary-200 transition-colors">
                  ...
                  <a href="mailto:info@mgfevent.com" className="flex items-center space-x-3 hover:text-primary-200 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
