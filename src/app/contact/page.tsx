...
export default function ContactPageRedesigned() {
  // Using the same form data structure as contacts-redesigned.tsx
  ...
  // WhatsApp integration functions from contacts-redesigned.tsx
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form - Using the form from contacts-redesigned.tsx */}
            ...
            <div className="space-y-8">
              ...
              <div className="rounded-3xl p-8 text-white" style={{background: `linear-gradient(135deg, #E55E27 0%, #D44D1C 100%)`}}>
                ...
                <div className="space-y-3">
                  <a href="tel:+919387039393" className="flex items-center space-x-3 hover:opacity-80 transition-all group">
                    <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white/30 transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                      </svg>
                    </div>
                    <span className="font-medium">+91 9387039393</span>
                  </a>
                  <a href="https://wa.me/919387039393" className="flex items-center space-x-3 hover:opacity-80 transition-all group">
                    <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white/30 transition-colors">
